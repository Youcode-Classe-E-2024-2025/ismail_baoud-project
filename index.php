...
include_once 'src/modules/role.php';
...
require_once 'src/controullers/member/update_status.php';
...
require_once 'src/controullers/CTO/permessions.php';
...
$routes = [
    ...
    '/update_status'=>'src/controullers/member/update_status.php',
